...
function Main() {
    return (
        <div className="row mt-6">
            ...
            I am a fullstack developer. I enjoy both designing websites and working with databases, perhaps one day I will choose a favorite, but not today. I have completed a Fullstack Developer course through the University of Utah with an A+ grade average, and obtained my <a href="https://www.credly.com/badges/4116dd08-a86a-49bb-a162-5b6569811c60" className="text-info" target="blank">Certificate of Completion.</a> All of my group projects have garnered class voted awards. I am fully capable of working with HTML, CSS, JS, React, MySql, MongoDB, Node, Express, and more. I have started to study Python, and intend to continue my studies into Java, React Native and Amazon Web Services.
            </p>
                <p className="about">
